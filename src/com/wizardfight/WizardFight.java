...
public class WizardFight extends Activity {
    ...
    private boolean isSpellButton =false;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        isSpellButton = appPrefs.getBoolean("spell_button", false);
        Log.e(TAG, sType);
        if (!isSpellButton) {
            ((CancelButton) findViewById(R.id.recButton)).setVisibility(View.INVISIBLE);
        } else {
            ((CancelButton) findViewById(R.id.recButton)).setOnTouchListener(new View.OnTouchListener() {
                @Override
