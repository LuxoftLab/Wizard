...
public class BluetoothService {
	 ...
	 * 
	 * @param state
	 *            An integer defining the current BT connection state
	 */
	private synchronized void setState(int state) {
		...
		if (mHandler != null) {
			mHandler.obtainMessage(AppMessage.MESSAGE_STATE_CHANGE.ordinal(),
	...
	/**
	 * Start the BT service. Specifically start AcceptThread to begin a session
	...
	public synchronized void connected(BluetoothSocket socket,
		...
		Message msg = mHandler.obtainMessage(AppMessage.MESSAGE_DEVICE_NAME
				.ordinal());
	...
	private void connectionFailed() {
		...
		Message msg = mHandler.obtainMessage(AppMessage.MESSAGE_CONNECTION_FAIL
				.ordinal());
		Bundle bundle = new Bundle();
			...
			while (true) {
				try {
					...
					mHandler.obtainMessage(
							AppMessage.MESSAGE_FROM_ENEMY.ordinal(), bytes, -1,
							buffer).sendToTarget();
				} catch (IOException e) {
